...
namespace GraphQLServer.Api.GraphQL.Types
{
    ...
    {
        public DocumentGraphType(IDocumentTypeRepository docTypeRepo, IKeywordRepository keywordRepo)
        {
            ...
            Field<DocumentTypeGraphType>("documentType",
                resolve: context => docTypeRepo.GetDocumentType(context.Source.DocumentId));
